    ...
    <div className="min-h-screen relative overflow-hidden -mt-16 pt-16">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <button
          ...
          className="fixed bottom-20 right-6 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center z-50"
        >
