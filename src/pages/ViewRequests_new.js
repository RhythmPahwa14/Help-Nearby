            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredRequests.map((req, index) => {
                ...
                return (
                  <div 
                    key={req.id} 
                    className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20 shadow-2xl hover:scale-105 transition-all duration-300 group"
                  ...
                  >
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-center text-gray-400 text-sm">
                        ...
                        Posted: {req.createdAt?.toDate().toLocaleString("en-IN", { timeZone: "Asia/Kolkata" })}
                      </div>
                    </div>
