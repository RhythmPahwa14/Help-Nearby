import React, { useEffec      className="min-h-screen relative overflow-hidden transition-colors duration-300"
      style={{
  ...
  return (
    <div 
      ...
      style={{
        ...
        color: 'var(--text-primary)',
        backgroundImage: `
          linear-gradient(rgba(var(--bg-primary-rgb), 0.9), rgba(var(--bg-primary-rgb), 0.9)),
          url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='%23ffffff' stroke-width='1' stroke-opacity='0.03'%3E%3Ccircle cx='20' cy='20' r='8'/%3E%3Ccircle cx='80' cy='20' r='8'/%3E%3Ccircle cx='50' cy='50' r='12'/%3E%3Ccircle cx='20' cy='80' r='8'/%3E%3Ccircle cx='80' cy='80' r='8'/%3E%3Cpath d='M20 20l30 30m30-30l-30 30m-30 30l30-30m30 30l-30-30'/%3E%3C/g%3E%3C/svg%3E")
        `,
        backgroundSize: '100px 100px'
      }}
    >
      ...
      {/* Hero Section */}
      <div className="flex items-center justify-center min-h-screen pt-28 pb-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6">
          ...
          <div className="mt-24 slide-in-bottom" style={{ animationDelay: '1.2s' }}>
            <h2 className="text-4xl font-bold text-white mb-12">How It Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="card text-center group hover:glow-cyan">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Post Request</h3>
                <p className="text-slate-400">Share what help you need with your location</p>
              </div>
              ...
              <div className="card text-center group hover:glow-cyan">
                ...
                <p className="text-slate-400">Nearby volunteers will see and respond to your request</p>
              </div>
              ...
              <div className="card text-center group hover:glow-cyan">
                ...
                <p className="text-slate-400">Connect with volunteers and receive the help you need</p>
              </div>
            </div>
          </div>
        </div>
